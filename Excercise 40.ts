...
const make_album = (artist: string, title: string, tracks?: number): any => {
  const album = {
    artist,
    title,
    tracks,
...
const album1 = make_album("K.Asif", "Mughal E Azam");
console.log(album1);

const album2 = make_album("Ashqui", "Mahesh bhat", 12);
console.log(album2);

const album3 = make_album("Nikhil Advani", "Kal Ho na Ho");
console.log(album3);
